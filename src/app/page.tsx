export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      <nav className="bg-white shadow-sm py-4">
        <div className="container mx-auto flex justify-between items-center px-8">
          ...
          <ul className="flex gap-8 text-gray-800">
            <li><a href="#home" className="hover:text-gray-600 font-medium">Home</a></li>
            <li><a href="#skills" className="hover:text-gray-600 font-medium">Skills</a></li>
            <li><a href="#experience" className="hover:text-gray-600 font-medium">Experience</a></li>
            <li><a href="#projects" className="hover:text-gray-600 font-medium">Projects</a></li>
            <li><a href="#contact" className="hover:text-gray-600 font-medium">Contact</a></li>
          </ul>
        </div>
      </nav>

      {/* Header Section */}
      <header id="home" className="relative bg-gradient-to-br from-blue-300 via-blue-200 to-purple-200 py-16 overflow-hidden">
      ...
      <section id="about" className="bg-gray-100 py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="mb-6">
            ...
            <h2 className="text-5xl font-black tracking-wide text-gray-800">ABOUT ME</h2>
          </div>
          <p className="text-gray-800 leading-relaxed text-xl mb-8">
            I am Daniel Avila, <span className="text-blue-600 font-semibold">a dedicated Desktop Support Technician currently working at STORIS, Inc.</span> and the County College of Morris IT Help Desk. With hands-on experience in hardware, software, and technical support, I strive to provide efficient solutions, manage IT assets, and deliver reliable support to end-users.
          </p>
          <a href="#contact" className="inline-block bg-blue-600 text-white px-10 py-4 rounded-full text-lg font-semibold hover:bg-blue-700 transition-colors">
            Connect
          </a>
        </div>
      </section>
      ...
      {/* Skills Section */}
      <section id="skills" className="bg-gradient-to-br from-blue-100 via-blue-50 to-purple-50 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex justify-end items-center mb-12">
            <h2 className="text-5xl font-black tracking-wide text-gray-800 mr-4">SKILLS</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
            <div className="flex flex-col items-center">
              <div className="bg-blue-400 p-8 rounded-2xl shadow-lg mb-4 w-40 h-40 flex items-center justify-center">
                <svg className="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Desktop</h3>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Support</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 text-center">Computer</h3>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Repair</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
              <div className="bg-blue-400 p-8 rounded-2xl shadow-lg mb-4 w-40 h-40 flex items-center justify-center">
                <svg className="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 7v6m0 0l-3-3m3 3l3-3" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Software</h3>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Installation</h3>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 text-center">Inventory</h3>
              <h3 className="text-xl font-semibold text-gray-800 text-center">Management</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Experience Section */}
      <section id="experience" className="bg-gradient-to-br from-blue-100 via-blue-50 to-purple-50 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <div className="w-48 h-1 bg-gray-800 mb-4"></div>
            <h2 className="text-5xl font-black tracking-wide text-gray-800">EXPERIENCE</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="relative">
              ...
              <div className="bg-blue-500 text-white rounded-3xl p-8 shadow-lg">
                ...
                <p className="mb-4 text-blue-100">STORIS, Inc&nbsp;&nbsp;&nbsp;Part time</p>
                <p className="leading-relaxed">
                  Install software and hardware on new laptops, manage IT inventory, resolve employee support tickets, and deploy laptops to remote staff
                </p>
              </div>
            </div>
            ...
            <div className="relative flex flex-col items-end">
              ...
              <div className="bg-blue-500 text-white rounded-3xl p-8 shadow-lg">
                ...
                <p className="mb-4 text-blue-100">County College of Morris&nbsp;&nbsp;&nbsp;Part time</p>
                <p className="leading-relaxed">
                  Troubleshoot devices (Windows, Mac, Linux, iOS, Android), support campus software, and assist with Wi-Fi/VPN connectivity
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="bg-blue-500 text-white rounded-3xl p-8 shadow-lg">
                <h3 className="text-2xl font-bold mb-3">Microsoft Office Specialist Certification</h3>
            ...
            <div className="relative flex flex-col items-end">
              ...
              <div className="bg-blue-500 text-white rounded-3xl p-8 shadow-lg">
                ...
                <p className="mb-4 text-blue-100">American Design Drafting Association</p>
                <p className="leading-relaxed">
                  Lorem ipsum detail.
                </p>
              </div>
      ...
      <section id="projects" className="bg-gray-200 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="flex justify-end items-center mb-16">
            <h2 className="text-5xl font-black tracking-wide text-gray-800 mr-4">PROJECTS</h2>
            <div className="w-48 h-1 bg-gray-800"></div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-400 rounded-3xl p-8 shadow-lg flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="flex-1 md:ml-8 text-white">
                ...
                <p className="text-lg leading-relaxed">
                  Assisted students and staff with technical troubleshooting across multiple platforms.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-400 rounded-3xl p-8 shadow-lg flex flex-col md:flex-row items-center justify-between">
              <div className="flex-1 md:mr-8 text-white order-2 md:order-1">
                ...
                <p className="text-lg leading-relaxed">
                  Managed configuration and deployment of laptops for remote employees at STORIS.
                </p>
              </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-gradient-to-br from-blue-100 via-blue-50 to-purple-50 py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="mb-16">
            <div className="w-48 h-1 bg-gray-800 mb-4"></div>
            <h2 className="text-5xl font-black tracking-wide text-gray-800">CONTACT</h2>
          </div>
            ...
            <div className="flex flex-col justify-center items-center text-center">
              <div className="flex gap-8 mb-8">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-gray-800 font-medium text-sm">Resume</span>
                </div>
