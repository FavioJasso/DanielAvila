export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-8 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <h1 className="text-[20rem] font-medium text-[#3970EB]/20 leading-none tracking-tight select-none">
              DANIEL
            </h1>
          </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="bg-[#F6F6F6] py-20 px-4">
        <div className="container mx-auto max-w-6xl">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-2 border-[#3970EB]/30 rounded-full px-6 py-3 focus:outline-none focus:border-[#3970EB] transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full border-2 border-[#3970EB]/30 rounded-3xl px-6 py-3 focus:outline-none focus:border-[#3970EB] transition-colors resize-none"
                  ></textarea>
                </div>
              </form>
            </div>
            ...
            <div className="flex flex-col justify-end items-end text-right">
              <div className="flex gap-8 mb-8">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[#212020] font-medium text-sm">
                    Resume
                  </span>
                </div>
              ...
              <p className="text-[#212020] text-lg font-medium">
